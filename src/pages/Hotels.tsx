      ...
      <section className="bg-gradient-primary py-16">
        <div className="container">
          ...
          <p className="mb-8 text-primary-foreground/80">
            Search from 500+ hotels and accommodations across Ghana
          </p>
          ...
          <div className="mb-6 flex flex-wrap items-center gap-3">
            ...
            <Select>
              ...
              <SelectContent>
                ...
                <SelectItem value="500+">GH₵ 500+</SelectItem>
              </SelectContent>
            </Select>
            <Select>
              <SelectTrigger className="w-[140px]">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {hotels.map((hotel) => (
              <Link
                key={hotel.id}
                to={`/hotels/${hotel.id}`}
                className="group overflow-hidden rounded-2xl border border-border bg-card transition-all hover:shadow-primary-md"
              >
